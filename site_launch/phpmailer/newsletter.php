...
try {
    ...
    $mail->setFrom('info@domain.com', 'Message from Citytours');             // Email Address and Name FROM
    $mail->addAddress('info@domain.com', 'Jhon Doe');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@domain.com', 'Citytours Newsletter');               // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Thank you for join to Citytours Newsletter';                 // Email Subject     
    ...
    $mail->isHTML(true);
    $mail->Subject    = 'Thank you for join to Citytours Newsletter'; // Custom subject
    $mail->Body = "Thank you for join to Citytours Newsletter. You can unsubscribe at any time!";
